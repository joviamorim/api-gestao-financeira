...
public class GlobalExceptionHandler {
        ...
        @ExceptionHandler(TransactionStartDateIsAfterException.class)
        public ResponseEntity<ApiError> handleTransactionStartDateIsAfter(TransactionStartDateIsAfterException ex) {
